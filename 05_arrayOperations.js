...
let tab = [1, 2, 3, 4]
const multiplyByTwo = tab.map(x => x*2);
...
const noms = ["Atef","Manuel", "Sara"];
const filterNameStartByA = noms.filter(nom => nom[0] === 'A');
...
const sum = array => array.reduce((x, val) => x + val, 0);
